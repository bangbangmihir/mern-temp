    ...
    return (
        <>
            ...
            <div className="p-1 my-container active-cont overflow-hidden">
                ...
                {/* <!--End Top Nav --> */}
                <h3 className="text-dark p-3">ADMIN CATEGORY DASHBOARD 💻 📱
                </h3>

                <div className="row ">
                    <div className="col-md-9"></div>
                    <div className="col-md-3 btn btn-secondary  mx-5"><Link to="/admin/addcategory" className="text-white nav-link">Add New category</Link></div>
                </div>
...

                {
                    !category ? <div className='row d-flex justify-content-center position-relative top-50 mt-5 ' style={{ height: "100vh" }}>
                        ...
                        category && category.map((category) => (
                            <>
                                <div className="row ">
                                    <div className="col-md-3 ">{category.categoryName}</div>
                                    ...
                                    <div className="col-md-3">
                                        <div className="row">
                                            ...
                                            <div className="col-md-4">
                                                <Link className="col-md-1" to={`/admin/editcategory/${category._id}`} ><AiFillEdit size={25} color="blue"/>  </Link>
                                            </div>
                                        </div>
                                    </div>
